...
h);c("screen-orientation",h);"fullscreen"===n?(c("x5-fullscreen","true"),c("full-screen","yes")):g&&(c("x5-page-mode","app"),c("browsermode","application"));if(m){var q=y(a.background_color||"#f8f9fa"),u=a.name||a.short_name||document.title;(n=F(a.related_applications))&&c("apple-itunes-app","app-id="+n);c("apple-mobile-web-app-capable",g);c("apple-mobile-web-app-title",u);var w=new Set;v(null);if(x.length){var l=x[0],p=new Image;p.onload=function(){v(p);if(a.background_color){var b=z(p,a.background_color);
null!==b&&(l.href=b,x.slice(1).forEach(function(b){var d=new Image;d.onload=function(){var c=z(d,a.background_color,!0);b.href=c};d.src=b.href}))}};p.src=l.href}}}function F(a){var b;(a||[]).filter(function(a){return"itunes"===a.platform}).forEach(function(a){a.id?b=a.id:(a=a.url.match(/id(\d+)/))&&(b=a[1])});return b}function E(a){a=String(a||"");a=a.substr(0,3);return"por"===a?"portrait":"lan"===a?"landscape":""}function C(a){if(m||G){var b=y(a);if(m)c("apple-mobile-web-app-status-bar-style",b?
"default":"black");else{try{var d=Windows.UI.ViewManagement.ApplicationView.getForCurrentView().titleBar}catch(v){d=null}null===d?console.debug("found Windows, could not fetch titleBar"):(d.foregroundColor=q(b?"black":"white"),d.backgroundColor=q(a))}}}function q(a){a=l(a);return{r:a[0],g:a[1],b:a[2],a:a[3]}}function l(a){var b=t();b.fillStyle=a;b.fillRect(0,0,1,1);return b.getImageData(0,0,1,1).data}function y(a){a=l(a).map(function(a){a/=255;return.03928>a?a/12.92:Math.pow((a+.055)/1.055,2.4)});
return 3<Math.abs(1.05/(.2126*a[0]+.7152*a[1]+.0722*a[2]+.05))}function z(a,b,c){c=void 0===c?!1:c;var d=t(a);d.drawImage(a,0,0);if(!c&&255==d.getImageData(0,0,1,1).data[3])return null;d.globalCompositeOperation="destination-over";d.fillStyle=b;d.fillRect(0,0,a.width,a.height);return d.canvas.toDataURL()}function t(a){a=void 0===a?{width:1,height:1}:a;var b=a.height,c=document.createElement("canvas");c.width=a.width;c.height=b;return c.getContext("2d")}if("fetch"in window){var B=["standalone","fullscreen",
"minimal-ui"],m=navigator.vendor&&-1!==navigator.vendor.indexOf("Apple"),D=navigator.userAgent&&-1!==navigator.userAgent.indexOf("Edge"),G="undefined"!==typeof Windows;"complete"===document.readyState?h():window.addEventListener("load",h)}})();
