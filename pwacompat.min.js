...
p("meta",{name:a,content:b}))}function n(a,b){function c(c,b){var l=c.width;c=c.height;var d=window.devicePixelRatio,f=q({width:l*d,height:c*d});f.scale(d,d);f.fillStyle=a.background_color||"#f8f9fa";f.fillRect(0,0,l,c);f.translate(l/2,(c-32)/2);f.font="24px Sans-Serif";f.fillStyle=n?"white":"black";var e=a.name||a.short_name||document.title,h=f.measureText(e).width;if(b){var g=b.width/d;d=b.height/d;128<d&&(g/=d/128,d=128);48<=g&&48<=d&&(f.drawImage(b,g/-2,d/-2,g,d),f.translate(0,d/2+32))}f.fillText(e,
