...
null}null===d?console.debug("found Windows, could not fetch titleBar"):(d.foregroundColor=q(b?"black":"white"),d.backgroundColor=q(a))}}}function q(a){a=l(a);return{r:a[0],g:a[1],b:a[2],a:a[3]}}function l(a){var b=t();b.fillStyle=a;b.fillRect(0,0,1,1);return b.getImageData(0,0,1,1).data}function y(a){a=l(a).map(function(a){a/=255;return.03928>a?a/12.92:Math.pow((a+.055)/1.055,2.4)});return 3<Math.abs(1.05/(.2126*a[0]+.7152*a[1]+.0722*a[2]+.05))}function z(a,b,d){d=void 0===d?!1:d;var c=t(a);c.drawImage(a,
0,0);if(!d&&255==c.getImageData(0,0,1,1).data[3])return null;c.globalCompositeOperation="destination-over";c.fillStyle=b;c.fillRect(0,0,a.width,a.height);return c.canvas.toDataURL()}function t(a){a=void 0===a?{width:1,height:1}:a;var b=a.height,c=document.createElement("canvas");c.width=a.width;c.height=b;return c.getContext("2d")}if("fetch"in window){var B=["standalone","fullscreen","minimal-ui"],m=navigator.vendor&&-1!==navigator.vendor.indexOf("Apple"),D=navigator.userAgent&&-1!==navigator.userAgent.indexOf("Edge"),
G="undefined"!==typeof Windows;"complete"===document.readyState?h():window.addEventListener("load",h)}})();
